...
echo "🚀 Installing Jorm-RS on Linux..."
...
if ! command -v python3 &> /dev/null; then
    ...
    print_warning "Consider installing Python3 for full functionality."
fi
...
# Download URL
DOWNLOAD_URL="https://github.com/${{ github.repository }}/releases/latest/download/jorm-rs-${OS}-${ARCH}.tar.gz"
